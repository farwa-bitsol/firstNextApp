    ...
    <div className="sm:col-span-3 my-4">
      ...
      <div className="mt-2">
        <input
          ...
          className="block w-full rounded-md border-0 px-5 py-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
        />
...
export default function Form({ currStep }: { currStep: number }) {
  ...
  const next = async () => {
    const fields = steps[currStep].fields;
